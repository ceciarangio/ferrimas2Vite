    ...
    <div className="whatsapp">
        ...
        <div className="ceje-excavadoras animate__animated animate__fadeInRight">
            <div className='excav-div'>
                ...
                <h3>{t("translated-excavadoras-1")}</h3>
            </div>
            <div className='excav-div'>
                
                <img src={mini3t} alt='excavadora 3t'/>
                <h3>{t("translated-excavadoras-2")}</h3>
            </div>
            <div className='excav-div'>
                
                <img src={mini5t} alt='excavadora 5t'/>
                <h3>{t("translated-excavadoras-3")}</h3>
            </div>
            <div className='excav-div'>
                
                <img src={excavadoras} alt='excavadoras'/>
                <h3>{t("translated-excavadoras-4")}</h3>
            </div>
            <div className='excav-div'>
                
                <img src={martilloexc} alt='Martillo'/>
                <h3>{t("translated-excavadoras-5")}</h3>
            </div>
            <div className='excav-div'>
                <img src={minipala} alt='mini pala'/>
                <h3>{t("translated-excavadoras-6")}</h3>
            </div>
        </div>
        <div>
            <Footer/>
